...
void MyPacket::setSeqNum(int seqNum)
{
    this->seqNum = seqNum;
}
...
const char * MyPacket::getPayload() const
{
...
void MyPacket::setCheckSum(const bits& checkSum)
{
...
void *MyPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    MyPacket *pp = (MyPacket *)object; (void)pp;
    switch (field) {
        case 5: return (void *)(&pp->getCheckSum()); break;
        default: return nullptr;
    }
}
